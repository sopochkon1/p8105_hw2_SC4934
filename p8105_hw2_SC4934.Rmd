...
there are 524 observations in the dataset. key variables include `dumpster`, which distinguishes dumpsters, and type, 
which shows whether the data belongs to mr. trash wheel or professor trash wheel. 




total weight of trash collected by professor trash wheel is 135.5 tons, while the total number of sports balls collected
